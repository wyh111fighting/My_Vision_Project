...
施加外力：`rosrun unitree_controller unitree_external_force`

控制站立：`rosrun unitree_controller unitree_move_kinetic`
...
## 说明
仅基于个人内容，部分不够完善，因为是新手，对于编程不熟练，部分代码编写不够完善，运行效果一般，还请谅解。
